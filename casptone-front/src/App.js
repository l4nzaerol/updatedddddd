    ...
    return (
        <Router>
            ...
            <Routes>
                ...
                <Route path="/inventory-analytics" element={isAuthenticated() ? <InventoryAnalytics /> : <Navigate to="/" />} /> 
                <Route path="/inventory-reports" element={isAuthenticated() ? <InventoryReportsDashboard /> : <Navigate to="/" />} /> 
