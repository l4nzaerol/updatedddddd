...
class SimpleAlkansyaSeeder extends Seeder
{
    /**
     * Run the database seeds.
     * Creates 3 months of Alkansya daily output data with material consumption tracking
     */
    public function run(): void
    {
        $this->log('🌱 Seeding 3 months of Alkansya daily output with material consumption...');
        ...
        // Initialize stock levels for materials
        $stockLevels = [];
