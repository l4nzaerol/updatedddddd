...
class InventoryItemsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // === FINISHED GOODS ===
        // ========================================
        $this->command->info('Adding finished goods to inventory...');
        
        // Alkansya Finished Good
        InventoryItem::updateOrCreate(
            ['sku' => 'FG-ALKANSYA'],
            [
                ...
                'description' => 'Alkansya ready for sale',
        ...
        // Dining Table Finished Good
        InventoryItem::updateOrCreate(
            ['sku' => 'MTO-DINING-TABLE'],
            [
                'name' => 'Dining Table (Finished Good)',
                'category' => 'finished',
                'location' => 'Windfield 2',
                'unit' => 'piece',
                'unit_cost' => 2500.00,
                'supplier' => 'In-House Production',
                'description' => 'Made to Order Table',
                'quantity_on_hand' => 0, // Will be updated by production
                'safety_stock' => 5,
                'reorder_point' => 10,
                'max_level' => 50,
        ...
        // Wooden Chair Finished Good
        InventoryItem::updateOrCreate(
            ['sku' => 'MTO-WOODEN-CHAIR'],
            [
                'name' => 'Wooden Chair (Finished Good)',
                'category' => 'finished',
                'location' => 'Windfield 2',
                'unit' => 'piece',
                'unit_cost' => 1200.00,
                'supplier' => 'In-House Production',
                'description' => 'Made to Order Chair',
                'quantity_on_hand' => 0, // Will be updated by production
                'safety_stock' => 10,
                'reorder_point' => 20,
                'max_level' => 100,
        ...
        $this->command->info('✓ All finished goods added to inventory!');
